...
export interface ContractStore {
  ...
  activeTab: 'home' | 'dashboard' | 'skyvision' | 'pinpoint' | 'quant' | 'auditor' | 'dealerflow' | 'liveterminal' | 'community' | 'settings' | 'admin' | 'subscription' | 'workspace';
  setActiveTab: (tab: 'home' | 'dashboard' | 'skyvision' | 'pinpoint' | 'quant' | 'auditor' | 'dealerflow' | 'liveterminal' | 'community' | 'settings' | 'admin' | 'subscription' | 'workspace', keepContract?: boolean) => void;
...
export const useContractStore = create<ContractStore>((set, get) => ({
  activeTab: (() => {
    ...
    const VALID = ['home', 'dashboard', 'skyvision', 'pinpoint', 'dealerflow', 'liveterminal', 'quant', 'auditor', 'community', 'settings', 'admin', 'subscription', 'workspace'];
